...
```json
{
  "mcpServers": {
    "nook-qwen-image": {
      "command": "node",
      "args": ["C:/nook-skills/nook-qwen-image/server/index.js"],
      "env": {
...
>
> ```bash
> codex mcp add nook-qwen-image -- node "C:/nook-skills/nook-qwen-image/server/index.js" --env MS_API_KEY=xxx
> ```
...
```json
{
  "cursor.mcp.servers": "{\"nook-qwen-image\":{\"command\":\"node\",\"args\":[\"C:/nook-skills/nook-qwen-image/server/index.js\"],\"env\":{\"MS_API_KEY\":\"xxx\"}}}",
  ...
}
```
...
```markdown
![img](file:///C:/nook-skills/nook-qwen-image/output/qwen_img_xxx.jpg)
```
