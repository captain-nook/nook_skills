...
The selected template is the highest visual authority.

A template is not a loose reference, mood board, or style hint. It is the source of layout, spacing, text scale, image slots, component proportions, decorative vocabulary, and visual hierarchy.
...
Do not create a new freeform rendering script when an approved template exists.
